  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#F5F7FA' }}>
      <View style={{ padding: 16, backgroundColor: '#EC3137', flexDirection: 'row', alignItems: 'center' }}>
        ...
        <Text style={{ fontSize: 18, fontWeight: '700', color: '#fff', marginLeft: 12 }}>Panel de Auditoria</Text>
      </View>
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
        <Text style={{ fontSize: 18, fontWeight: '700', color: '#334155', marginBottom: 8 }}>Panel de Auditoria</Text>
        <Text style={{ fontSize: 13, color: '#94A3B8', textAlign: 'center', paddingHorizontal: 40 }}>
          Proximamente podras revisar registros de auditoria del sistema.
        </Text>
      </View>
    </SafeAreaView>
  );
