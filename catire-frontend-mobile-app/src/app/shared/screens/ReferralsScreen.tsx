            ...
            <View style={{
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
                <View style={{ alignItems: 'center' }}>
                  <Text style={{ fontSize: 24, fontWeight: '700', color: theme.colors.primary }}>{stats.total}</Text>
                  <Text style={{ fontSize: 12, color: theme.colors.textMuted }}>Total</Text>
                </View>
                <View style={{ alignItems: 'center' }}>
                  <Text style={{ fontSize: 24, fontWeight: '700', color: '#10B981' }}>{stats.completed}</Text>
                  <Text style={{ fontSize: 12, color: theme.colors.textMuted }}>Completados</Text>
                </View>
                <View style={{ alignItems: 'center' }}>
                  <Text style={{ fontSize: 24, fontWeight: '700', color: '#F59E0B' }}>{stats.pending}</Text>
                  <Text style={{ fontSize: 12, color: theme.colors.textMuted }}>Pendientes</Text>
                </View>
                <View style={{ alignItems: 'center' }}>
                  <Text style={{ fontSize: 24, fontWeight: '700', color: '#8B5CF6' }}>{stats.points}</Text>
                  <Text style={{ fontSize: 12, color: theme.colors.textMuted }}>Puntos</Text>
                </View>
              </View>
            </View>
